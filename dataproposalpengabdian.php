...
<head>
    ...
    <title>Data Proposal Pengabdian</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="text-center">
                    <h5><b>Data</b> Proposal Pengabdian</h5>
                    ...
                    ?>
                        <div class="card mb-3"
                            ...
                            <div class="card-body">
                                ...
                                <?php
                echo"<a href=\"terimaproposalpengabdian.php?id=$res[id]\" class='btn btn-outline-success mr-2'>Terima</a>";
                echo"<a href=\"revisiproposalpengabdian.php?id=$res[id]\" class='btn btn-outline-primary mr-2'>Revisi</a>";
                echo "<a href=\"deleteproposalpengabdian.php?id=$res[id]\" class='btn btn-outline-danger'><i class='fa fa-trash'></i></a>"; 
                ?>
                            </div>
                        </div>
                        <?php
