            ...
            <div id="content">
                ...
                <div style='display:flex; margin:2rem; text-align:center; justify-content:center;'>
                    <div style='margin-left:1rem;'>
                        <a href="totalproposalpengabdian.php" style='text-decoration:none;' type='button'
                            class='btn btn-outline-primary'>
                            Total Proposal Pengabdian: <?=$countproposalpengabdian;?>
                        </a>
                    </div>
                    <div style='margin-left:1rem;'>
                        <a href="totalproposalpenelitian.php" style='text-decoration:none;' type='button'
                            class='btn btn-outline-success'>
                            Total Proposal Penelitian: <?=$countproposalpenelitian;?>
                        </a>
                    </div>
                    <div style='margin-left:1rem;'>
                        <a href="totalsurattugas.php" style='text-decoration:none;' type='button'
                ...
                <div style='margin:1rem; padding:2rem;'>
                    <div class="card text-center mb-5" style='border-radius:1rem;'>
                        <div class="card-body">
                            ...
                            <a href="dataproposalpengabdian.php" class="btn btn-primary">Read More</a>
                        </div>
                    </div>
                    <div class="card text-center" style='border-radius:1rem;'>
                        <div class="card-body">
                            <h5 class="card-title">Data Proposal Penelitian</h5>
                            <a href="dataproposalpenelitian.php" class="btn btn-primary">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <section id='content-wrapper' style='margin-top:7.3rem;'>
