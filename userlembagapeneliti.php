...
<head>
    ...
    <title>User Lembaga Peneliti</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <?php
                                        $no=1;
            $result = mysqli_query($conn, "SELECT * FROM userlembagapeneliti ORDER BY idUserLp ASC");
          ...
          ?>
                ...
                <!-- End of Page Wrapper -->
                <section id='content-wrapper' style='margin-top:14.6rem;'>
