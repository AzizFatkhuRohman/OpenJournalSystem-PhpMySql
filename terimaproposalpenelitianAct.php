...
if(isset($_POST['submit'])){
    $email=$_POST['email'];
    $hasil=$_POST['hasil'];
    $sql="insert into `hasilProposal` (email,hasil) values ('$email','$hasil')";
...
$email=$_POST['email'];
    ...
    $mail->Subject = 'Konfirmasi Proposal Anda Di Terima';
    $mail->Body    = 'Silahkan Lakukan Langkah Selanjutnya';

    if($mail->send()){
        echo"<script> alert('Konfirmasi Anda Telah Di Kirim')</script>";
    }else{
