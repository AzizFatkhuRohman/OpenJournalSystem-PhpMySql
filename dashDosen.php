    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <div class="row" style='text-align:center; margin-top:5rem; margin-left:2rem; margin-right:2rem'>
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Unggah Proposal Pengabdian</h5>

                                <a href="proposalpengabdian.php" class="btn btn-primary">Unggah</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Unggah Proposal Penelitian</h5>

                                <a href="proposalpenelitian.php" class="btn btn-primary">Unggah</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <section id='content-wrapper' style='margin-top:23rem;'>
