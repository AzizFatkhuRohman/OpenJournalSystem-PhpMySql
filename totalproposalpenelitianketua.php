        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                                    ...
                                    <tr>
                                        ...
                                        if($cari){
                                            if($input ==""){
                                                ...
                                                $result = mysqli_query($conn, "SELECT * FROM proposalpenelitian WHERE nama LIKE '%$input%' OR email LIKE '%$input%'
                                        ...
                                        <td>
                                            <?php
                                        echo"<a href=\"detailpenelitianketua.php?id=$res[id]\"
                    ...
                    <section id='content-wrapper' style='margin-top:23.7rem'>
