...
$result = mysqli_query($conn, "SELECT * FROM proposalpenelitian ORDER BY id DESC");
...
<head>
    ...
    <title>Data Proposal Penelitian</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="text-center">
                    <h5><b>Data</b> Proposal Penelitian</h5>
                    <div id="content" class="componenCard" style="margin: 2px; justify-content: center;">
                        <?php
                    ...
                    ?>
                        <div class="card mb-3"
                            ...
                            <embed type="application/pdf" width='max' height='350px'
                                src="fileproposalpenelitian/<?php echo $res['file'];?>">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $res['nama'];?></h5>
                                <p class="card-text"><?php echo $res['email']?></p>
                                <p class="card-text"><?php echo $res['judul']?></p>
                                <p class="card-text"><?php echo $res['kategori']?></p>
                                <p class="card-text"><?php echo $res['tanggal']?></p>
                                <p class="card-text"><?php echo $res['lokasi']?></p>
                                <?php
                echo"<a href=\"terimaproposalpenelitian.php?id=$res[id]\" class='btn btn-outline-success mr-2'>Terima</a>";
                echo"<a href=\"revisiproposalpenelitian.php?id=$res[id]\" class='btn btn-outline-primary mr-2'>Revisi</a>";
                echo "<a href=\"deleteproposalpenelitian.php?id=$res[id]\" class='btn btn-outline-danger'><i class='fa fa-trash'></i></a>"; 
                ?>
                            </div>
                        </div>
                        <?php
