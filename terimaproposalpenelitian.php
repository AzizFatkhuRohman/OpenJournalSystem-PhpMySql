...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM proposalpenelitian WHERE id=$id");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div style='margin-top:1rem; margin-bottom:1rem; text-align:center;'>
                    <h4>Proposal Di Terima</h4>
                </div>
                <form action="terimaproposalpenelitianAct.php" method="post" style="justify-content: center;
                    border-radius: 1rem;
                    text-align: center;
                    margin: 1rem;
                    ...
                    <div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="email"
                                value="<?php echo $email?>" style="background-color: rgb(199, 199, 199);">
                        </div>
                        <div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Di Terima</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1" value=" Di Terima"
                                    name="hasil" style="background-color: rgb(199, 199, 199);">
                            </div>
                        </div>

                    </div>
                    <button type="submit" name="submit" class="btn btn-outline-primary" style="margin: 2px;"><i
            ...
            <section id='content-wrapper' style='margin-top:16.3rem;'>
